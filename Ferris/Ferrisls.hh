...
//        RootContextFactory Factory;
    ...
    public:
        ...
        typedef boost::signals2::signal< void ( Ferrisls&, fh_context ) > DiskReadStarted_Sig_t;
        DiskReadStarted_Sig_t& getDiskReadStarted_Sig();

        typedef boost::signals2::signal< void ( Ferrisls&, fh_context ) > DiskReadDone_Sig_t;
        DiskReadDone_Sig_t& getDiskReadDone_Sig();

        typedef boost::signals2::signal< void ( Ferrisls&, fh_context, long ) > DiskReadProgress_Sig_t;
        DiskReadProgress_Sig_t& getDiskReadProgress_Sig();

        typedef boost::signals2::signal< void ( Ferrisls& ) > FilterStarted_Sig_t;
        FilterStarted_Sig_t& getFilterStarted_Sig();

        typedef boost::signals2::signal< void ( Ferrisls& ) > SortStarted_Sig_t;
        SortStarted_Sig_t& getSortStarted_Sig();

        typedef boost::signals2::signal< void ( Ferrisls&, fh_context ) > ContextPropergationStarted_Sig_t;
...
//        void setRoot( const std::string& c );
        ...
        typedef boost::signals2::signal< void ( Ferrisls&, fh_context ) > EnteringContext_Sig_t;
        EnteringContext_Sig_t& getEnteringContext_Sig();
        typedef boost::signals2::signal< void ( Ferrisls&, fh_context ) > LeavingContext_Sig_t;
