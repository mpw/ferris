...
namespace FerrisUI
{
    ...
    public:
        ...
        typedef boost::signals2::signal< void ( fh_context ) > StartReadingDiskSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > StopReadingDiskSig_t;
        typedef boost::signals2::signal< void ( fh_context, long, long ) > DiskReadProgressSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > StartReadingSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > StopReadingSig_t;
        typedef boost::signals2::signal< void ( fh_context, long, long ) > AddingContextSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > RemovingContextSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > FilterStartedSig_t;
        typedef boost::signals2::signal< void ( fh_context ) > SortStartedSig_t;

        typedef boost::signals2::signal< void ( FerrisTreeModel* ) > ClearedSig_t;
